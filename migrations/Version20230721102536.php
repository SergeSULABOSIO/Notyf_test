 ...
 */
final class Version20230721102536 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE action_crm DROP piste_id, DROP attributed_to_id');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE action_crm ADD piste_id INT DEFAULT NULL, ADD attributed_to_id INT DEFAULT NULL');
