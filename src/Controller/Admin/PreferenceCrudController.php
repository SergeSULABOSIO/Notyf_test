...
class PreferenceCrudController extends AbstractCrudController
{
    ...
    public const TAB_PRO_ASSUREURS = [
        ...
        self::PREF_PRO_ASSUREUR_ADRESSE                         => 3,
        self::PREF_PRO_ASSUREUR_TELEPHONE                       => 4,
        self::PREF_PRO_ASSUREUR_EMAIL                           => 5,
        self::PREF_PRO_ASSUREUR_SITE_WEB                        => 6,
        self::PREF_PRO_ASSUREUR_RCCM                            => 7,
        self::PREF_PRO_ASSUREUR_IDNAT                           => 8,
        self::PREF_PRO_ASSUREUR_LICENCE                         => 9,
        self::PREF_PRO_ASSUREUR_NUM_IMPOT                       => 10,
        self::PREF_PRO_ASSUREUR_IS_REASSUREUR                   => 11,
        self::PREF_PRO_ASSUREUR_UTILISATEUR                     => 12,
        self::PREF_PRO_ASSUREUR_ENTREPRISE                      => 13,
        self::PREF_PRO_ASSUREUR_DATE_DE_CREATION                => 14,
        self::PREF_PRO_ASSUREUR_DATE_DE_MODIFICATION            => 15,
        //CHAMPS CALCULABLES AUTOMATIQUEMENT
        self::PREF_calc_polices_tab                             => 16,
        ...
        self::PREF_calc_revenu_ttc_encaisse_tab_ref_factures    => 27,
        self::PREF_calc_revenu_ttc_solde_restant_du             => 28,
        self::PREF_calc_retrocom                                => 29,
        self::PREF_calc_retrocom_payees                         => 30,
        self::PREF_calc_retrocom_payees_tab_factures            => 31,
        self::PREF_calc_retrocom_solde                          => 32,
        self::PREF_calc_taxes_courtier_tab                      => 33,
        self::PREF_calc_taxes_courtier                          => 34,
        self::PREF_calc_taxes_courtier_payees                   => 35,
        self::PREF_calc_taxes_courtier_payees_tab_ref_factures  => 36,
        self::PREF_calc_taxes_courtier_solde                    => 37,
        self::PREF_calc_taxes_assureurs_tab                     => 38,
        self::PREF_calc_taxes_assureurs                         => 39,
        self::PREF_calc_taxes_assureurs_payees                  => 40,
        self::PREF_calc_taxes_assureurs_payees_tab_ref_factures => 41,
        self::PREF_calc_taxes_assureurs_solde                   => 42
    ];
    //PRODUCTION - ENGIN
    ...
    public const TAB_PRO_POLICES = [
        ...
        self::PREF_PRO_POLICE_COTATION                          => 28,
