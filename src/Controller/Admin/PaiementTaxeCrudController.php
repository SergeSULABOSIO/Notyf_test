...
class PaiementTaxeCrudController extends AbstractCrudController
{
    ...
    {
        $this->serviceSuppression->supprimer($entityInstance, ServiceSuppression::FINANCE_PAIEMENT_TAXE);
    }
    ...
    public function configureActions(Actions $actions): Actions
    {
        ...
        return $actions
            ...
            ->update(Crud::PAGE_INDEX, Action::NEW, function (Action $action) {
                return $action->setIcon('fas fa-person-chalkboard')->setCssClass('btn btn-primary')->setLabel(DashboardController::ACTION_AJOUTER);
            })
