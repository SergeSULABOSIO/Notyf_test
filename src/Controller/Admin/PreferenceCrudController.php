...
class PreferenceCrudController extends AbstractCrudController
{
    ...
    public const TAB_PRO_POLICES = [
        ...
        self::PREF_calc_taxes_courtier_solde                    => 55,
        self::PREF_calc_taxes_assureurs_tab                     => 56,
        self::PREF_calc_taxes_assureurs                         => 57,
        self::PREF_calc_taxes_assureurs_payees                  => 58,
        self::PREF_calc_taxes_assureurs_solde                   => 59,
        self::PREF_calc_sinistre_dommage_total                  => 60,
        self::PREF_calc_sinistre_indemnisation_total            => 61,
        self::PREF_calc_sinistre_indice_SP                      => 62,
        self::PREF_PRO_POLICE_PISTES                            => 63,
    ];
    //PRODUCTION - PRODUIT
