...
class PartenaireUIBuilder extends JSPanelBuilder
{
    ...
    private ?ProduitFormRenderer $formRendere = null;
    ...
    {
        $this->listeRendere = new ProduitListeRenderer(
            $entityManager,
            $serviceMonnaie,
            $serviceTaxes,
            $pageName,
    ...
    {
        $this->formRendere = new ProduitFormRenderer(
            $entityManager,
            $serviceMonnaie,
            $serviceTaxes,
            $pageName,
    ...
    {
        $this->detailsRendere = new ProduitDetailsRenderer(
            $entityManager,
            $serviceMonnaie,
            $serviceTaxes,
            $pageName,
