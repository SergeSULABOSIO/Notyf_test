...
{
    private ?PartenaireListeRenderer $listeRendere = null;
    private ?PartenaireDetailsRenderer $detailsRendere = null;
    private ?PartenaireFormRenderer $formRendere = null;
    ...
    {
        $this->listeRendere = new PartenaireListeRenderer(
            $entityManager,
            $serviceMonnaie,
            $serviceTaxes,
            $pageName,
    ...
    {
        $this->formRendere = new PartenaireFormRenderer(
            $entityManager,
            $serviceMonnaie,
            $serviceTaxes,
            $pageName,
    ...
    {
        $this->detailsRendere = new PartenaireDetailsRenderer(
            $entityManager,
            $serviceMonnaie,
            $serviceTaxes,
            $pageName,
