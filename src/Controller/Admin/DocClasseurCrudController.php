...
class DocClasseurCrudController extends AbstractCrudController
{
    ...
    {
        return DocClasseur::class;
    }

    public function configureCrud(Crud $crud): Crud
    {
        //Application de la préférence sur la taille de la liste
        $this->servicePreferences->appliquerPreferenceTaille(new DocClasseur(), $crud);
        $this->crud = $crud
    ...
    {
        $this->serviceSuppression->supprimer($entityInstance, ServiceSuppression::BIBLIOTHEQUE_CLASSE);
    }


    public function createEntity(string $entityFqcn)
    {
        $objet = new DocClasseur();
    ...
    {
        return $this->servicePreferences->getChamps(new DocClasseur(), $this->crud, $this->adminUrlGenerator);
    }
    ...
    public function configureActions(Actions $actions): Actions
    {
        ...
        ->update(Crud::PAGE_INDEX, Action::NEW, function (Action $action) {
            return $action->setIcon('fas fa-folder-open')->setCssClass('btn btn-primary')->setLabel(DashboardController::ACTION_AJOUTER);
        })
