 ...
 */
final class Version20230720111400 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cotation_doc_piece (cotation_id INT NOT NULL, doc_piece_id INT NOT NULL, INDEX IDX_8857D2805D14FAF0 (cotation_id), INDEX IDX_8857D280A5BBD2F3 (doc_piece_id), PRIMARY KEY(cotation_id, doc_piece_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
