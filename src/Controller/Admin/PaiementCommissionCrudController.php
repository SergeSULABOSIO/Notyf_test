...
class PaiementCommissionCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        return $this->servicePreferences->getChamps(new PaiementCommission(), $this->crud, $this->adminUrlGenerator);
    }
    ...
    {
        return $this->redirect($this->serviceCrossCanal->crossCanal_POPCom_attacherPiece($context, $adminUrlGenerator));
    }
}
