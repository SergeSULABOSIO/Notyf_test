...
class PaiementPartenaireCrudController extends AbstractCrudController
{
    ...
    {
        $this->serviceSuppression->supprimer($entityInstance, ServiceSuppression::FINANCE_PAIEMENT_PARTENAIRE);
    }
    ...
    public function createEntity(string $entityFqcn)
    {
        ...
        $objet = $this->serviceCrossCanal->crossCanal_POPRetroComm_setPolice($objet, $this->adminUrlGenerator);
    ...
    public function configureActions(Actions $actions): Actions
    {
        ...
        return $actions
            ...
            ->update(Crud::PAGE_INDEX, Action::NEW, function (Action $action) {
                return $action->setIcon('fas fa-person-arrow-up-from-line')->setCssClass('btn btn-primary')->setLabel(DashboardController::ACTION_AJOUTER);
            })
