...
class FactureTaxeAssureurInit implements FactureInit
{
    ...
    public function produireElementFacture(): ?ElementFacture
    {
        ...
        $elementFacture->setMontant($this->tranche->getTaxeAssureurTotale());
    ...
    {
        return "Taxe " . $this->tranche->getAutoriteTaxeAssureur() .
            $this->tranche->getNom() .
            " : Ref. police: " .
    ...
    public function buildFacture(?int $indice, ?Tranche $tranche): ?Facture
    {
        ...
        $this->setType(FactureCrudController::TAB_TYPE_FACTURE[FactureCrudController::TYPE_FACTURE_NOTE_DE_PERCEPTION_TVA]);
