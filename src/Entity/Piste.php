...
class Piste implements Sujet, CommandeExecuteur
{
    ...
    public function setNom(string $nom): self
    {
        ...
        $this->nom = $nom;
        //Ecouteur d'action
        $this->executer(new CommandePisteDetecterChangementAttribut($this, "Nom", $oldValue, $nom, Evenement::FORMAT_VALUE_PRIMITIVE));
        return $this;
    }
    ...
    public function setObjectif(string $objectif): self
    {
        ...
        //Ecouteur d'action
        $this->executer(new CommandePisteDetecterChangementAttribut($this, "Objectif", $oldValue, $objectif, Evenement::FORMAT_VALUE_PRIMITIVE));
        return $this;
    }
    ...
    public function setCreatedAt(\DateTimeImmutable $createdAt): self
    {
        ...
        //Ecouteur d'action
        $this->executer(new CommandePisteDetecterChangementAttribut($this, "Date de création", $oldValue, $createdAt, Evenement::FORMAT_VALUE_PRIMITIVE));
    ...
    public function setUpdatedAt(\DateTimeImmutable $updatedAt): self
    {
        ...
        //Ecouteur d'action
        $this->executer(new CommandePisteDetecterChangementAttribut($this, "Date de modification", $oldValue, $updatedAt, Evenement::FORMAT_VALUE_PRIMITIVE));
    ...
    public function setMontant(?float $montant): self
    {
        ...
        //Ecouteur d'action
        $this->executer(new CommandePisteDetecterChangementAttribut($this, "Montant", $oldValue, $newValue, Evenement::FORMAT_VALUE_PRIMITIVE));
        return $this;
    }
    ...
    public function setExpiredAt(\DateTimeImmutable $expiredAt): self
    {
        ...
        //Ecouteur d'action
        $this->executer(new CommandePisteDetecterChangementAttribut($this, "Date d'expiration", $oldValue, $expiredAt, Evenement::FORMAT_VALUE_PRIMITIVE));
    ...
    public function addCotation(Cotation $cotation): self
    {
        if (!$this->cotations->contains($cotation)) {
            ...
            //Ecouteur d'action
            $this->executer(new CommandePisteDetecterChangementAttribut($this, "Liste des cotations", $oldValue, $cotation, Evenement::FORMAT_VALUE_ENTITY));
        }
        return $this;
    }
    ...
    public function removeCotation(Cotation $cotation): self
    {
        if ($this->cotations->removeElement($cotation)) {
            ...
            if ($cotation->getPiste() === $this) {
                ...
                //Ecouteur d'action
                $this->executer(new CommandePisteDetecterChangementAttribut($this, "Liste des cotations", $oldValue, null, Evenement::FORMAT_VALUE_ENTITY));
            }
        }
    ...
    public function setTypeavenant(?string $typeavenant): self
    {
        ...
        //Ecouteur d'action
        $this->executer(new CommandePisteDetecterChangementAttribut($this, "Type d'avenant", $oldValue, $typeavenant, Evenement::FORMAT_VALUE_PRIMITIVE));
    ...
    public function setPolice(?Police $police): self
    {
        ...
        $this->police = $police;
        //Ecouteur d'action
        $this->executer(new CommandePisteDetecterChangementAttribut($this, "Police", $oldValue, null, Evenement::FORMAT_VALUE_ENTITY));
    ...
    public function addContact(Contact $contact): self
    {
        if (!$this->contacts->contains($contact)) {
            ...
            //Ecouteur d'action
            $this->executer(new CommandePisteDetecterChangementAttribut($this, "Liste des Contacts", $oldValue, $contact, Evenement::FORMAT_VALUE_ENTITY));
        }
    ...
    public function removeContact(Contact $contact): self
    {
        if ($this->contacts->removeElement($contact)) {
            ...
            if ($contact->getPiste() === $this) {
                ...
                //Ecouteur d'action
                $this->executer(new CommandePisteDetecterChangementAttribut($this, "Liste des Contacts", $oldValue, null, Evenement::FORMAT_VALUE_ENTITY));
            }
        }
    ...
    public function addActionsCRM(ActionCRM $actionsCRM): self
    {
        if (!$this->actionsCRMs->contains($actionsCRM)) {
            ...
            //Ecouteur d'action
            $this->executer(new CommandePisteDetecterChangementAttribut($this, "Liste d'actions", $oldValue, $actionsCRM, Evenement::FORMAT_VALUE_ENTITY));
        }
    ...
    public function removeActionsCRM(ActionCRM $actionsCRM): self
    {
        if ($this->actionsCRMs->removeElement($actionsCRM)) {
            ...
            if ($actionsCRM->getPiste() === $this) {
                ...
                //Ecouteur d'action
                $this->executer(new CommandePisteDetecterChangementAttribut($this, "Liste d'actions", $oldValue, null, Evenement::FORMAT_VALUE_ENTITY));
            }
        }
    ...
    public function setClient(?Client $client): self
    {
        ...
        //Ecouteur d'action
        $this->executer(new CommandePisteDetecterChangementAttribut($this, "Client", $oldValue, $newValue, Evenement::FORMAT_VALUE_ENTITY));
    ...
    public function addProspect(Client $prospect): self
    {
        if (!$this->prospect->contains($prospect)) {
            ...
            //Ecouteur d'action
            $this->executer(new CommandePisteDetecterChangementAttribut($this, "Liste des prospects", $oldValue, $prospect, Evenement::FORMAT_VALUE_ENTITY));
        }
    ...
    public function removeProspect(Client $prospect): self
    {
        if ($this->prospect->removeElement($prospect)) {
            ...
            if ($prospect->getPiste() === $this) {
                ...
                //Ecouteur d'action
                $this->executer(new CommandePisteDetecterChangementAttribut($this, "Liste des prospects", $oldValue, null, Evenement::FORMAT_VALUE_ENTITY));
            }
        }
    ...
    public function setProduit(?Produit $produit): self
    {
        ...
        //Ecouteur d'action
        $this->executer(new CommandePisteDetecterChangementAttribut($this, "Produit", $oldValue, $newValue, Evenement::FORMAT_VALUE_ENTITY));
    ...
    public function setPartenaire(?Partenaire $partenaire): self
    {
        ...
        //Ecouteur d'action
        $this->executer(new CommandePisteDetecterChangementAttribut($this, "Partenaire", $oldValue, $newValue, Evenement::FORMAT_VALUE_ENTITY));
    ...
    public function addNewpartenaire(Partenaire $newpartenaire): self
    {
        if (!$this->newpartenaire->contains($newpartenaire)) {
            ...
            //Ecouteur d'action
            $this->executer(new CommandePisteDetecterChangementAttribut($this, "Nouveau Partenaire", $oldValue, $newValue, Evenement::FORMAT_VALUE_ENTITY));
        }
    ...
    public function setGestionnaire(?Utilisateur $gestionnaire): self
    {
        ...
        //Ecouteur d'action
        $this->executer(new CommandePisteDetecterChangementAttribut($this, "Gestionnaire de compte", $oldValue, $newValue, Evenement::FORMAT_VALUE_ENTITY));
    ...
    public function setAssistant(?Utilisateur $assistant): self
    {
        ...
        //Ecouteur d'action
        $this->executer(new CommandePisteDetecterChangementAttribut($this, "Assistant", $oldValue, $newValue, Evenement::FORMAT_VALUE_ENTITY));
    ...
    public function addPolice(Police $police): self
    {
        if (!$this->polices->contains($police)) {
            ...
            //Ecouteur d'action
            $this->executer(new CommandePisteDetecterChangementAttribut($this, "Liste des Polices", $oldValue, $newValue, Evenement::FORMAT_VALUE_ENTITY));
        }
    ...
    public function addDocument(DocPiece $document): self
    {
        if (!$this->documents->contains($document)) {
            ...
            //Ecouteur d'action
            $this->executer(new CommandePisteDetecterChangementAttribut($this, "Liste des Documents", $oldValue, $newValue, Evenement::FORMAT_VALUE_ENTITY));
        }
    ...
    public function setEtape(?int $etape): self
    {
        ...
        $this->etape = $etape;
        //Ecouteur d'action
        $this->executer(new CommandePisteDetecterChangementAttribut($this, "Etape", $oldValue, $newValue, Evenement::FORMAT_VALUE_PRIMITIVE));
