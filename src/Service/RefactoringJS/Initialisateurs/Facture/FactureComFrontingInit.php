...
class FactureComFrontingInit implements FactureInit
{
    ...
    public function produireElementFacture(): ?ElementFacture
    {
        ...
        $elementFacture->setMontant($this->tranche->getComFronting());
    ...
    {
        return "Commission sur fronting ou céssion - " .
            $this->tranche->getNom() .
            " : Ref. police: " .
    ...
    public function buildFacture(?int $indice, ?Tranche $tranche): ?Facture
    {
        ...
        $this->setType(FactureCrudController::TAB_TYPE_FACTURE[FactureCrudController::TYPE_FACTURE_COMMISSION_FRONTING]);
