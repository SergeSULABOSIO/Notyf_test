...
class ServicePreferences
{
    ...
    public function setCRM_Fields_SinistreVictimes_form($tabAttributs)
    {
        ...
        $tabAttributs[] = TelephoneField::new('telephone', PreferenceCrudController::PREF_SIN_VICTIME_TELEPHONE)
            ->setColumns(3)
            ->onlyOnForms();
        $tabAttributs[] = AssociationField::new('sinistres', PreferenceCrudController::PREF_SIN_VICTIME_SINISTRE)
            ->setColumns(12)
            ->onlyOnForms();
    ...
    public function setCRM_Fields_PaiementCommissions_Index_Details(array $tabPreferences, array $tabDefaultAttributs, $tabAttributs)
    {
        ...
        if ($this->canShow($tabPreferences, $tabDefaultAttributs[PreferenceCrudController::PREF_FIN_PAIEMENTS_COMMISSIONS_DOCUMENTS])) {
            $tabAttributs[] = AssociationField::new('pieces', PreferenceCrudController::PREF_FIN_PAIEMENTS_COMMISSIONS_DOCUMENTS)
                ->hideOnForm();
        }
    ...
    public function setCRM_Fields_SinistreSinistres_Index_Details(array $tabPreferences, array $tabDefaultAttributs, $tabAttributs)
    {
        ...
        if ($this->canShow($tabPreferences, $tabDefaultAttributs[PreferenceCrudController::PREF_SIN_SINISTRE_VICTIMES])) {
            $tabAttributs[] = ArrayField::new('victime', PreferenceCrudController::PREF_SIN_SINISTRE_VICTIMES)
                ->hideOnForm();
        }
    ...
    public function setCRM_Fields_SinistreVictimes_Index_Details(array $tabPreferences, array $tabDefaultAttributs, $tabAttributs)
    {
        ...
        if ($this->canShow($tabPreferences, $tabDefaultAttributs[PreferenceCrudController::PREF_SIN_VICTIME_SINISTRE])) {
            $tabAttributs[] = ArrayField::new('sinistres', PreferenceCrudController::PREF_SIN_VICTIME_SINISTRE)
                ->hideOnForm();
        }
    ...
    public function setAttributs_Calculables($isPolice, array $tabAttributs, array $tabPreferences, array $tabIndiceAttribut)
    {
        ...
        if ($isPolice == false) {
            ...
            if ($this->canShow($tabPreferences, $tabIndiceAttribut[PreferenceCrudController::PREF_calc_polices_tab])) {
                $tabAttributs[] = AssociationField::new('calc_polices_tab', PreferenceCrudController::PREF_calc_polices_tab)
                    ->onlyOnIndex();
        ...
        if ($this->canShow($tabPreferences, $tabIndiceAttribut[PreferenceCrudController::PREF_calc_taxes_courtier_tab])) {
            $tabAttributs[] = AssociationField::new('calc_taxes_courtier_tab', $this->getTitreAttributTaxe(self::INDICE_TAXE_COURTIER, "Desc", PreferenceCrudController::PREF_calc_taxes_courtier_tab)) //
                ->onlyOnIndex();
        ...
        if ($this->canShow($tabPreferences, $tabIndiceAttribut[PreferenceCrudController::PREF_calc_taxes_assureurs_tab])) {
            $tabAttributs[] = AssociationField::new('calc_taxes_assureurs_tab', $this->getTitreAttributTaxe(self::INDICE_TAXE_ASSUREUR, "Desc", PreferenceCrudController::PREF_calc_taxes_assureurs_tab))
                ->onlyOnIndex();
    ...
    public function setCRM_Fields_Cotation_Index_Details(array $tabPreferences, array $tabDefaultAttributs, $tabAttributs)
    {
        ...
        if ($this->canShow($tabPreferences, $tabDefaultAttributs[PreferenceCrudController::PREF_CRM_COTATION_PIECES])) {
            $tabAttributs[] = AssociationField::new('docPieces', PreferenceCrudController::PREF_CRM_COTATION_PIECES)
                ->onlyOnIndex();
            $tabAttributs[] = ArrayField::new('docPieces', PreferenceCrudController::PREF_CRM_COTATION_PIECES)
                ->onlyOnDetail();
        }
