...
class ObservateurEntiteApresSuppression extends ObservateurAbstract implements CommandeExecuteur
{
    ...
    public function ecouter(?Evenement $evenement)
    {
        ...
        if($this->superviseurSujet != null){
            $this->superviseurSujet->onEntiteApresSuppression($evenement);
        }
    }
