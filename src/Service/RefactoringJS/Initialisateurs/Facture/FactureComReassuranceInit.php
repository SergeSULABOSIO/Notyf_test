...
class FactureComReassuranceInit implements FactureInit
{
    ...
    public function buildFacture(?int $indice, ?Tranche $tranche): ?Facture
    {
        ...
        $this->setType(FactureCrudController::TAB_TYPE_FACTURE[FactureCrudController::TYPE_FACTURE_COMMISSION_REASSURANCE]);
