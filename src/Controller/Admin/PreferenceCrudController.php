...
class PreferenceCrudController extends AbstractCrudController
{
    ...
    public const TAB_PRO_PARTENAIRES = [
        ...
        self::PREF_PRO_PARTENAIRE_ADRESSE                       => 4,
        self::PREF_PRO_PARTENAIRE_EMAIL                         => 5,
        self::PREF_PRO_PARTENAIRE_SITEWEB                       => 6,
        self::PREF_PRO_PARTENAIRE_RCCM                          => 7,
        self::PREF_PRO_PARTENAIRE_IDNAT                         => 8,
        self::PREF_PRO_PARTENAIRE_NUM_IMPOT                     => 9,
        self::PREF_PRO_PARTENAIRE_UTILISATEUR                   => 10,
        self::PREF_PRO_PARTENAIRE_ENTREPRISE                    => 11,
        self::PREF_PRO_PARTENAIRE_DATE_DE_CREATION              => 12,
        self::PREF_PRO_PARTENAIRE_DATE_DE_MODIFICATION          => 13,
        //CHAMPS CALCULABLES AUTOMATIQUEMENT
    ...
    public const TAB_PRO_POLICES = [
        ...
        self::PREF_PRO_POLICE_POP_PARTENAIRES                   => 22,
        self::PREF_PRO_POLICE_CLIENT                            => 23,
        self::PREF_PRO_POLICE_PRODUIT                           => 24,
        self::PREF_PRO_POLICE_PARTENAIRE                        => 25,
        self::PREF_PRO_POLICE_PART_EXCEPTIONNELLE               => 26,
        self::PREF_PRO_POLICE_REASSUREURS                       => 27,
        self::PREF_PRO_POLICE_ASSUREURS                         => 28,
        self::PREF_PRO_POLICE_COTATION                          => 29,
        self::PREF_PRO_POLICE_GESTIONNAIRE                      => 30,
        self::PREF_PRO_POLICE_CANHSARE_RI_COM                   => 31,
        self::PREF_PRO_POLICE_CANHSARE_LOCAL_COM                => 32,
        self::PREF_PRO_POLICE_CANHSARE_FRONTING_COM             => 33,
        self::PREF_PRO_POLICE_RI_COM_PAYABLE_BY                 => 34,
        self::PREF_PRO_POLICE_FRONTING_COM_PAYABLE_BY           => 35,
        self::PREF_PRO_POLICE_LOCAL_COM_PAYABLE_BY              => 36,
        self::PREF_PRO_POLICE_PIECES                            => 37,
        self::PREF_PRO_POLICE_UTILISATEUR                       => 38,
        self::PREF_PRO_POLICE_ENTREPRISE                        => 39,
        self::PREF_PRO_POLICE_DATE_DE_CREATION                  => 40,
        self::PREF_PRO_POLICE_DATE_DE_MODIFICATION              => 41,
        //CHAMPS CALCULABLES AUTOMATIQUEMENT
        ...
        self::PREF_calc_revenu_reserve                          => 42,
        self::PREF_calc_revenu_partageable                      => 43,
        self::PREF_calc_revenu_ht                               => 44,
        self::PREF_calc_revenu_ttc                              => 45,
        self::PREF_calc_revenu_ttc_encaisse                     => 46,
        self::PREF_calc_revenu_ttc_encaisse_tab_ref_factures    => 47,
        self::PREF_calc_revenu_ttc_solde_restant_du             => 48,
        self::PREF_calc_retrocom                                => 49,
        self::PREF_calc_retrocom_payees                         => 50,
        self::PREF_calc_retrocom_payees_tab_factures            => 51,
        self::PREF_calc_retrocom_solde                          => 52,
        self::PREF_calc_taxes_courtier_tab                      => 53,
        self::PREF_calc_taxes_courtier                          => 54,
        self::PREF_calc_taxes_courtier_payees                   => 55,
        self::PREF_calc_taxes_courtier_payees_tab_ref_factures  => 56,
        self::PREF_calc_taxes_courtier_solde                    => 57,
        self::PREF_calc_taxes_assureurs_tab                     => 58,
        self::PREF_calc_taxes_assureurs                         => 59,
        self::PREF_calc_taxes_assureurs_payees                  => 60,
        self::PREF_calc_taxes_assureurs_payees_tab_ref_factures => 61,
