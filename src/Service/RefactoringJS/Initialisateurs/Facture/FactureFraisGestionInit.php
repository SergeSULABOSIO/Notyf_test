...
class FactureFraisGestionInit implements FactureInit
{
    ...
    public function produireElementFacture(): ?ElementFacture
    {
        ...
        $elementFacture->setMontant($this->tranche->getComFraisGestion());
    ...
    public function buildFacture(?int $indice, ?Tranche $tranche): ?Facture
    {
        ...
        $this->setType(FactureCrudController::TAB_TYPE_FACTURE[FactureCrudController::TYPE_FACTURE_FRAIS_DE_GESTION]);
