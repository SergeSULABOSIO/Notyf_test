 ...
 */
final class Version20230720223200 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE piste_action_crm (piste_id INT NOT NULL, action_crm_id INT NOT NULL, INDEX IDX_F5CF447AC34065BC (piste_id), INDEX IDX_F5CF447A2ECC6D6F (action_crm_id), PRIMARY KEY(piste_id, action_crm_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE piste_contact (piste_id INT NOT NULL, contact_id INT NOT NULL, INDEX IDX_D3E56148E7A1254A (contact_id), INDEX IDX_D3E56148C34065BC (piste_id), PRIMARY KEY(piste_id, contact_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
