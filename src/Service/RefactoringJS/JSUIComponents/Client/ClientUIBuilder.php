...
use App\Service\RefactoringJS\JSUIComponents\Client\ClientFormRenderer;
use App\Service\RefactoringJS\JSUIComponents\Client\ClientListeRenderer;
use App\Service\RefactoringJS\JSUIComponents\Client\ClientDetailsRenderer;
use App\Service\RefactoringJS\JSUIComponents\JSUIParametres\JSPanelBuilder;

class ClientUIBuilder extends JSPanelBuilder
{
    private ?ClientListeRenderer $listeRendere = null;
    private ?ClientDetailsRenderer $detailsRendere = null;
    private ?ClientFormRenderer $formRendere = null;
    ...
    {
        $this->listeRendere = new ClientListeRenderer(
            $entityManager,
            $serviceMonnaie,
            $serviceTaxes,
            $pageName,
    ...
    {
        $this->formRendere = new ClientFormRenderer(
            $entityManager,
            $serviceMonnaie,
            $serviceTaxes,
            $pageName,
    ...
    {
        $this->detailsRendere = new ClientDetailsRenderer(
            $entityManager,
            $serviceMonnaie,
            $serviceTaxes,
            $pageName,
