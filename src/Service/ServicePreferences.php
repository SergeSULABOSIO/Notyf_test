...
class ServicePreferences
{
    ...
    public function setAttributs_Calculables($isPolice, array $tabAttributs, array $tabPreferences, array $tabIndiceAttribut)
    {
        ...
        //SINISTRE
        $tabAttributs[] = FormField::addPanel('Sinistre')->setIcon('fa-solid fa-toggle-off')
            ->hideOnForm();
    ...
    public function setCRM_Fields_Pistes_Index_Details(array $tabPreferences, array $tabDefaultAttributs, $tabAttributs, Crud $crud, AdminUrlGenerator $adminUrlGenerator)
    {
        $this->crud = $crud;
        $this->adminUrlGenerator = $adminUrlGenerator;
