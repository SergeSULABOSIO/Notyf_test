...
class CommentaireSinistreCrudController extends AbstractCrudController
{
    ...
    {
        return CommentaireSinistre::class;
    }

    public function configureCrud(Crud $crud): Crud
    {
        //Application de la préférence sur la taille de la liste
        $this->servicePreferences->appliquerPreferenceTaille(new CommentaireSinistre(), $crud);
        return $crud
    ...
    {
        $this->serviceSuppression->supprimer($entityInstance, ServiceSuppression::SINISTRE_COMMENTAIRE);
    }
