...
use App\Service\RefactoringJS\JSUIComponents\Victime\VictimeUIBuilder;
use EasyCorp\Bundle\EasyAdminBundle\Controller\AbstractCrudController;
use App\Service\RefactoringJS\Commandes\ComDefinirObservateursEvenements;

class VictimeCrudController extends AbstractCrudController implements CommandeExecuteur
{
    public ?VictimeUIBuilder $uiBuilder = null;
    ...
    public function __construct(
        ...
        $this->uiBuilder = new VictimeUIBuilder();
    }
    ...
    public function configureCrud(Crud $crud): Crud
    {
        ...
        $this->servicePreferences->appliquerPreferenceTaille(new Victime(), $crud);
        $this->crud = $crud
    ...
    {
        /** @var Victime */
        $victimeToDelete = $entityInstance;
        ...
        //déconnexion au sinistre
        $victimeToDelete->setSinistre(null);

        //destruction définitive de la piste
        $this->entityManager->remove($victimeToDelete);
        $this->entityManager->flush();
        // $this->serviceSuppression->supprimer($entityInstance, ServiceSuppression::SINISTRE_VICTIME);
    }
    ...
    {
        $objet = new Victime();
        $objet = $this->serviceCrossCanal->crossCanal_Victime_setSinistre($objet, $this->adminUrlGenerator);
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        // return $this->servicePreferences->getChamps(new Victime(), $this->crud, $this->adminUrlGenerator);
    }
    ...
    public function configureActions(Actions $actions): Actions
    {
        ...
        return $actions
            ...
            ->update(Crud::PAGE_INDEX, Action::NEW, function (Action $action) {
                return $action->setIcon('fas fa-person-falling-burst')->setCssClass('btn btn-primary')->setLabel(DashboardController::ACTION_AJOUTER);
            })
