...
class PaiementRetroComInit implements PaiementInit
{
    ...
    public function buildPaiement(?Facture $facture, ?DateTimeImmutable $dateOfPayment, ?Utilisateur $utilisateur, ?float $paidAmount): ?Paiement
    {
        ...
        $this->paiement->setDescription("Paiement de la rétrocommission. Facture n°" . $facture . ". Versement effectué le " . $this->serviceDates->getTexte($dateOfPayment));
