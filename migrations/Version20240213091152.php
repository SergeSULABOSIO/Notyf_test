 ...
 */
final class Version20240213091152 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE facture DROP compte_bancaires');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE facture ADD compte_bancaires VARCHAR(255) DEFAULT NULL');
    }
}
