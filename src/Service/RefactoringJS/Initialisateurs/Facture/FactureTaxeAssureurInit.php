...
class FactureTaxeAssureurInit extends AbstractFacture
{
    ...
    {
        return $this->serviceTaxes->getTaxe(false)->getNom();
    }
    public function getTypeFacture(): ?string
    {
        return FactureCrudController::TYPE_FACTURE_NOTE_DE_PERCEPTION_TVA;
    }
}
